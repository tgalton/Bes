...
from . import views
from .views import  HouseworkMadeTaskDateRangeView, generate_invitation, accept_invitation
...
urlpatterns = [
    ...
    # path('api/tasks/made/create/', HouseworkMadeTaskCreateView.as_view(), name='housework_madetask_create'),
